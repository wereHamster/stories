...
<Grid style={{ margin: "20px 0" }}>
  <Exhibit caption="Intrinsic aspect ratio">
    <Sample variant="basic" />
  </Exhibit>
  <Exhibit caption="Fill available area (height: 200px)">
    <div style={{ display: 'grid', height: 200 }}>
      <Sample variant="basic" captionStyle="overlay" layout="fill" objectFit="cover" />
    </div>
  </Exhibit>
</Grid>
